...
const Navbar = () => {
  ...
  return (
    <nav className="container mx-auto py-2 flex justify-between items-center border-b border-purple-300 px-5 rounded-xl shadow-xl">
      ...
      <ul className={`text-gray-400 lg:text-sm text-xl lg:gap-y-0 gap-y-5 lg:text-left text-right flex lg:flex-row flex-col  transition-all duration-1000 ${isOpen ? 'right-6 top-20' : '-right-full top-20'} gap-x-14 lg:static fixed font-normal`}>
        {
